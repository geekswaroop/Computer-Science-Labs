...
// //int P, R;
// using namespace std;
// int allocated[105][105], max[105][105], need[105][105];
// bool is_available(int process_id, int available[]) 
// { 
...
// void safe_sequences(bool marked[], int available[], vector<int> safe) 
// { 
...
//         if (!marked[i] && is_available(i,available)) { 
...
//             safe_sequences(marked, available, safe); 
//             safe.pop_back(); 
...
// 	scanf("%d", &l);
// 	printf("Enter total number of types of resources:\n");
// 	scanf("%d", &m);
